...
// 
{
	...
	*/
	...
	addPlugToManipConversionCallback(xWidthFn.startPointIndex(),
		(plugToManipConversionCallback)&BasicLocatorManip::centerPointCallback);

	addPlugToManipConversionCallback(xWidthFn.directionIndex(),
		(plugToManipConversionCallback)&BasicLocatorManip::sideDirectionCallback);
	...
	addPlugToManipConversionCallback(zWidthFn.directionIndex(),
		(plugToManipConversionCallback)&BasicLocatorManip::backDirectionCallback);
